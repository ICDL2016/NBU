...
<div class="onecourse-underfooter">
  <div class="container">
    <div class="onecourse-underfooter__subtitle">Курс обучения</div>
    <div class="title onecourse-underfooter__title">Маркетинговые исследования</div>

    <div class="onecourse-underfooter__blocks">
      <div class="onecourse-underfooter__block">
        <div class="onecourse-underfooter__name">Частей и тестов</div>
        <div class="onecourse-underfooter__img">
          <img src="img/underfooter/1.png" alt="icon">
        </div>
        <div class="onecourse-underfooter__oldnum"></div>
        <div class="onecourse-underfooter__num">12</div>
      </div>

      <div class="onecourse-underfooter__block">
        <div class="onecourse-underfooter__name">Объем курса</div>
        <div class="onecourse-underfooter__img">
          <img src="img/underfooter/2.png" alt="icon">
        </div>
        <div class="onecourse-underfooter__oldnum"></div>
        <div class="onecourse-underfooter__num">60 ч.</div>
      </div>

      <div class="onecourse-underfooter__block">
        <div class="onecourse-underfooter__name">Стоимость курса</div>
        <div class="onecourse-underfooter__img">
          <img src="img/underfooter/3.png" alt="icon">
        </div>
        <div class="onecourse-underfooter__oldnum onecourse-underfooter__oldnum-course">59000</div>
        <div class="onecourse-underfooter__num onecourse-underfooter__num-course">29400 р.</div>
      </div>
    </div>

    <div class="button video-button onecourse-underfooter__button">Начать обучение бесплатно</div>
    <div class="onecourse-underfooter__date">Сегодня 25.04.2019</div>
  </div>
</div>
